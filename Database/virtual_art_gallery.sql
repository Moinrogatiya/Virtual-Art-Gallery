...
INSERT INTO `art_category` VALUES (1,'Painting','there are 7 types of Painting'),(2,'Sculpture','there are 4 type of the sculpture'),(3,'Digital Photography','there are 3 types added by us you can choose other option which is not from the above 3'),(4,'Sketching','there are 4 type of sketching'),(5,'eeeee','eeeeeeeee'),(6,'ttttttttt','dddddddddddd');
...
INSERT INTO `artist` VALUES (7,'hello'),(10,'hello'),(11,'xxxxxxxxxxxxxx'),(12,'yyyyyyyyyyyyyyyy'),(13,'ooooooooooooooooo'),(16,'rrrrrrrrrrrrrrrrrrrrrrr'),(17,'aaaaaaaaaaa'),(18,'fff');
...
INSERT INTO `brand` VALUES (1,'Camel','AAAAAAAAAAAAAAA'),(2,'Faber-Castell','FFFFFFFFFFF'),(3,'LANA','LLLLLLLLLLLLLLL'),(4,'xx','YYYYYYYY'),(5,'pixel','ddddddddddddd'),(6,'aaa','aaaaa dfdf'),(7,'bbb','bbb dfdf'),(8,'cc','ccccc'),(9,'wer','sddddddddd'),(10,'gg','ffffffff'),(11,'h','hhhhh'),(12,'www','dddddd');
...
INSERT INTO `product` VALUES (1,'x',123,'ddddd',3,NULL,2,2);
...
INSERT INTO `product_category` VALUES (1,'color','aaaaaaaaaaa'),(2,'notebook','BBBBBBBBBBBb'),(3,'brush','cccccccccccc'),(4,'canvas','dddddddddddddddd'),(5,'Pen','Pens dfdf'),(6,'aaa','aaaaa dfdf'),(7,'d','dddd'),(8,'eeeeee','rrrrrrrr');
...
INSERT INTO `psub_category` VALUES (1,'watercolor','tttttt',1),(2,'a4 nootbook','grgggggg',2),(3,'a3 nootbook','ffffffffffff',2),(4,'flat brush','ddddddddd',3),(5,'round brush','ffffffffff',3),(6,'3*3','ddddddddd',4),(7,'4*8','eeeeeeeeeee',4);
...
-- Dump completed on 2024-08-15  7:07:08
