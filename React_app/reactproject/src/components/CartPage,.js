...
export default function CartPage() {
  ...
  const removeFromCart = (id) => {
    const updatedCartItems = cartItems.filter((item) => item.art_id !== id);
            ...
            <div className="card-body">
              {cartItems.length > 0 ? (
                <div className="list-group">
                  {cartItems.map((item) => (
                    <div className="list-group-item d-flex justify-content-between align-items-center" key={item.art_id}>
                      <div className="d-flex align-items-center">
                        <img
                          src={URL.createObjectURL(
                            new Blob([new Uint8Array(item.art_photo)])
                          )}
                        ...
                        />
                        <div>
                          <h5 className="mb-1">{item.art_name}</h5>
                          <p className="mb-1">
                      ...
                      {!showOrderSummary && (
                        <button
                          ...
                          onClick={() => removeFromCart(item.art_id)}
                        >
