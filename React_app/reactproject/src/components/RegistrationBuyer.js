...
export default function RegistrationComp() {
  ...
  const submitHandle = (e) => {
    ...
    if (Object.keys(formErrors).length === 0) {
      ...
      fetch("http://localhost:5077/api/UserManagement/Savebuyer", {
        method: 'POST',
  ...
  return (
    ...
    >
      ...
      >
        <h1 className="text-center text-dark mb-3">Buyer Registration Form</h1>
        <form onSubmit={submitHandle} className="p-3">
          ...
          {/* City and Area in a single row */}
          <div className="row">
            <div className="col-md-6 mb-3">
              <label htmlFor="cityId" className="form-label">City <span className="text-danger">*</span></label>
              <div className="input-group">
            ...
            <div className="col-md-6 mb-3">
              <label htmlFor="areaId" className="form-label">Area <span className="text-danger">*</span></label>
              <div className="input-group">
                <span className="input-group-text bg-primary text-white border-0"><FaMapMarkerAlt /></span>
                {/* <input
                  type="text"
                  className={`form-control ${errors.areaError ? "is-invalid" : ""}`}
                  name="areaId"
                  value={user.areaId}
                ...
                /> */}
                 <select
                    ...
                    value={user.areaId}
                    onChange={(e) => dispatch({ type: 'update', fld: 'areaId', val: e.target.value })}
                    disabled={!user.cityId || areas.length === 0}
                  >
          ...
          {/* Username and Password in a single row */}
          <div className="row">
            <div className="col-md-6 mb-3">
